        ...
        <table style="width: 100%; border-collapse: collapse;">
            <thead>
                <tr>
                    ...
                    <th style="padding: 15px; text-align: left;">Pimpinan Pujian</th>
            ...
            <tbody>
                @forelse($schedules as $schedule)
                    <tr>
                        <td style="padding: 15px;">{{ $schedule->tanggal->format('d/m/Y') }}</td>
                        ...
                        <td style="padding: 15px;">
                            <div style="display: flex; gap: 5px;">
                                <a href="{{ route('worship-schedules.prayer-schedules.edit', $schedule->id) }}"
