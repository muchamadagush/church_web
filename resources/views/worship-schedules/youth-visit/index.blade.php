    ...
    <form method="POST" action="{{ route('worship-schedules.youth-visit.generate') }}">
      ...
      <div style="padding:15px; background:#f0f9ff; border-left:4px solid #3b82f6; margin-bottom:20px; border-radius:4px;">
        ...
        <ul style="margin:10px 0 0 20px; color:#1e3a8a;">
          ...
          <li><strong>Setiap gereja minimal 1 jadwal</strong> dalam 1 tahun</li>
          <li><strong>Urutan gereja di-random</strong> (tidak berurutan alfabetis)</li>
          <li><strong>Semua jadwal di hari Minggu</strong> (minggu random dalam bulan tersebut)</li>
          <li>Jam acak antara 09:00 atau 13:00</li>
          <li>Pimpin pujian: KM [Nama Gereja]</li>
